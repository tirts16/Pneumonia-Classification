...
class RLlibFLModel(FLModel):
    ...
    def __init__(self, model_name, model_spec):
        """
    ...
    def fit_model(self, train_data=None, fit_params=None):
        """
        ...
        try:
            for i in range(RLlibFLModel._run_config.get('iterations')):
                ...
                self.train_result = self.model.train()
        ...
        logger.info('Total time to train in seconds : %s', time.time() - start)
    ...
    def evaluate_model(self, x=None, y=None, batch_size=128, **kwargs):
        ...
        dict_metrics = {'episode_reward_mean': result}
        return dict_metrics
