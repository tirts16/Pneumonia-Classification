...
class XrayKerasDataHandler(DataHandler):
    """
    Data handler for chestxray dataset.
    """
    ...
    def get_data(self, nb_points=500):
        ...
        if self.file_name is None:
            (x_train, y_train), (x_test, y_test) = load_xray()
...
class XrayKerasDataGenerator(DataHandler):
    ...
    def __init__(self, data_config):
        ...
        self.train_datagenerator = train_gen.flow(
            X_train, y_train, batch_size=28)
        self.test_datagenerator = train_gen.flow(X_test, y_test, batch_size=28)
